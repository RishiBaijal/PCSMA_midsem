...
<h3>Congratulations ${requestScope.newUser}. You have been registered successfully! , <a href="${pageContext.request.contextPath}/login">login </a>to take the exam.</h3>
</div>
